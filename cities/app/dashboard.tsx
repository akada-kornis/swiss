  ...
  return <main className="app-shell">
    ...
    <section className="workspace">
      ...
      <section className="kpi-grid" aria-label="Indicateurs clés">
        ...
        <article className="kpi-card prime-card"><div className="kpi-top"><span className="kpi-label">Clients Prime</span><img className="prime-one" src="/prime-one-negative.svg" alt="Prime" /></div><strong>{stats.prime}</strong><p>{number.format(stats.primePopulation)} habitants identifiés</p></article>
